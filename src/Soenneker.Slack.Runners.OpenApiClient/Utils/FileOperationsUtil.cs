...
using Soenneker.Slack.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Slack.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Slack:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/connectstrata/slack-openapi-generator/refs/heads/main/slack-openapi-spec.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Slack OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "SlackOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
